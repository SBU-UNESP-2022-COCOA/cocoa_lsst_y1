...
emu_path_pce = './projects/lsst_y1/Emulators/PCE/'
sys.path.insert(0,emu_path_pce)
from PCE import emu_default, emu_high
#BERNARDO ends
...
class _cosmolike_prototype_base(DataSetLikelihood):
  ...
  def initialize(self, probe):
    ...
    if self.non_linear_emul == 1:
      ...
      self.emulator = pce_emu = emu_high # This is a reference to the module
      ...
      self.ks_emu =   np.logspace(np.log10(0.01)  ,np.log10(3),200) 
      self.qs_reduced2 = []
      self.pcas2 = []
      self.means2 = []
