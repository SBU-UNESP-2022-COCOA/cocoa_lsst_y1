...
class emu_cons(object):
    ...
    def __init__(self):
        ...
        self.ks_cola = np.loadtxt(f'{current_dir}/projects/lsst_y1/Emulators/PCE/ks_cola_default.txt') 
        ...
        for i in self.redshift_default_:
            ...
            self.polys[i] = numpoly.loadtxt(f'{current_dir}/projects/lsst_y1/Emulators/PCE/emu_z' + str(i) +'_colapc15_nsmear_all_1.0%_def.txt')
